...
function SetLayout()
    ...
    log.Trace('SetLayout()... ')
    local controls = import(modScripts..'score_board.lua').controls
    local mapGroup = import(modScripts..'score_board.lua').savedParent
    --TODO-FAF local controls = import('/lua/ui/game/score.lua').controls
    --TODO-FAF local mapGroup = import('/lua/ui/game/score.lua').savedParent
    ...
    LayoutHelpers.AtRightTopIn(controls.collapseArrow, mapGroup, -3, top + 14)
    controls.collapseArrow.Depth:Set(function() return controls.bg.Depth() + 10 end)
    
    LayoutHelpers.AtRightTopIn(controls.bg, mapGroup, 18, top)
    --TODO-FAF LayoutHelpers.AtRightTopIn(controls.bg, mapGroup, 18, 7)
